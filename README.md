...
| Input | Output |
| ----- | ------ |
|  user = {userName: "Lauren", userName: "lhanna7", isActive: true}   |  Welcome back, "Lauren", "lhanna7"!      | 
|  user = {userName: "Lauren", userName: "lhanna7", isActive: false}     |    Hey "Lauren", "lhanna7"! Would you like to renew your subscription?    | 
|       |        | 
